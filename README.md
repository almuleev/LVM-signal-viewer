> **Looking for the current version? See [AMSignal](https://github.com/almuleev/AM-graph-viewer).**
...
Development has moved to [AMSignal](https://github.com/almuleev/AM-graph-viewer), a complete C++ rewrite with significantly improved performance.

➡️ New users should use [AMSignal](https://github.com/almuleev/AM-graph-viewer) instead.
